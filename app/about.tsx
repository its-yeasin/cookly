      ...
      <ThemedView style={styles.container}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.appSection}>
            ...
            <ThemedText style={styles.version}>Version 1.1.0</ThemedText>
          </View>
          ...
          <View style={styles.section}>
            <ThemedText style={styles.description}>
              ...
              passionate about bringing delicious recipes and cooking
              inspiration right to your fingertips.
            </ThemedText>

            <ThemedText style={styles.description}>
              Our mission is to make cooking accessible, enjoyable, and
              rewarding for everyone, whether you&apos;re a beginner in the
              kitchen or a seasoned chef looking for new ideas.
            </ThemedText>
          </View>
          ...
          <View style={styles.section}>
            ...
            >
              ...
              />
              <ThemedText
                style={[styles.legalButtonText, { color: tintColor }]}
              >
                Privacy Policy
              </ThemedText>
